...
## Using Fetch data with Apollo starter files

You can use these starter files to skip to the start of [Fetch data with Apollo](https://developers.shopify.com/tutorials/build-a-shopify-app-with-node-and-react/fetch-data-with-apollo), but make sure that you first complete these setup instructions:
...
8. [Set up your app navigation.](https://developers.shopify.com/tutorials/build-a-shopify-app-with-node-and-react/fetch-data-with-apollo#set-up-your-app-navigation)
